# nohup python -u /home/francesco/data_scratch/swiss-ndvi-processing/demo/area_visulization/lowland_evergreen.py > output_low_ever.log 2>&1 &
...
out_gif_combined = "ndvi_lowland_evergreen_combined.gif"
