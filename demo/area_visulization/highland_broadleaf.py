# nohup python -u /home/francesco/data_scratch/swiss-ndvi-processing/demo/area_visulization/highland_broadleaf.py > output_high_broadleaf.log 2>&1 &
...
plot_results(
        ...
        save_path=f"pixel_{random_pixels}_gapfilled.png"
    )

print("done")


out_gif_combined = "ndvi_highland_broadleaf_combined.gif"
