# nohup python /home/francesco/data_scratch/swiss-ndvi-processing/demo/area_visulization/lowland_broadleaf.py > output_broadleaf.log 2>&1 &
...
ndvi_chunk = np.empty((T, len(sel)), dtype=np.float32)
