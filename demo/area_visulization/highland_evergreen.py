# nohup python /home/francesco/data_scratch/swiss-ndvi-processing/demo/area_visulization/highland_evergreen.py > output_high_evergreen.log 2>&1 &
...
z_out =  zarr.open("/home/francesco/data_scratch/swiss-ndvi-processing/highland_evergreen.zarr/ndvi")
