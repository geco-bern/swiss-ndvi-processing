#   nohup python -u /home/francesco/data_scratch/swiss-ndvi-processing/demo/notebook/fire.py >  /home/francesco/data_scratch/swiss-ndvi-processing/demo/output/log/fire.log 
# 2>/dev/null &
...
# ----- center cooridnates  -----
center_x, center_y =  2644029.37, 1134128.20 
...
full_index = full_index[(full_index >= "2023-01-01") ]
...
for i, pixel_sel in enumerate(sel):
    ...
    df = df.loc[df.index >= pd.Timestamp("2023-01-01")]
    ...
    for date in df.index[df.index >= pd.Timestamp("2023-01-01")]:
...
out_gif_combined_1 = "/home/francesco/data_scratch/swiss-ndvi-processing/demo/output/gif/fire.mp4"
