#   nohup python -u /home/francesco/data_scratch/swiss-ndvi-processing/demo/notebook/lowland_broadleaf.py >  /home/francesco/data_scratch/swiss-ndvi-processing/demo/output/log/low_broad.log 
# 2>/dev/null &
