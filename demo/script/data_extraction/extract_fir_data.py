# nohup python /home/francesco/data_scratch/swiss-ndvi-processing/demo/extract_fir_data.py > output.log 2>&1 &
...
bbox_swiss_4326 = [7.9958091403159965, 46.33800179890188, 8.023048457332893, 46.36051916009676]
...
ndvi_ds = zarr.create_array(
    name="ndvi",
    store='/home/francesco/data_scratch/swiss-ndvi-processing/fire-data.zarr',
    shape=(T, N),
    chunks=(1, N),
    dtype="int16",
