# python /home/francesco/data_scratch/swiss-ndvi-processing/demo/script/data_extraction/extract_lowland_broadleaf.py
...
ndvi_ds = zarr.create_array(
    name="ndvi",
    store='/home/francesco/data_scratch/swiss-ndvi-processing/lowland_broadleaf.zarr',
    shape=(T, len(sel)),
    chunks=(1, len(sel)),
    dtype="float32",
    fill_value=np.nan,
