...
# if running interactively use e.g.:
    # HISTO_ZARR = "/mnt/data2/UniBe-swiss-ndvi/input_data/ndvi_historic_v4_compr_1000mX1000m.zarr"
    # HISTO_ZARR = "/mnt/data2/UniBe-swiss-ndvi/input_data/ndvi_historic_v5_chk_40000_365_1kmX1km.zarr"
import warnings
