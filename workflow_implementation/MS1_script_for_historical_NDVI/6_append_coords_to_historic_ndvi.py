...
HISTORIC_ZARR    = "/data_3/scratch/francesco/ndvi_historic.zarr"
HISTORIC_ZARR_v3 = "/data_3/scratch/francesco/ndvi_historic_v3.zarr"
...
for it in range(5,6): # only run case 5 which appears to be fast and yield good compression
    match it:
        case 0:
            HISTORIC_ZARR_v3_compr = "/data_3/scratch/francesco/ndvi_historic_v3_uncompressed.zarr"
            compressor = None
        case 1:
            HISTORIC_ZARR_v3_compr = "/data_3/scratch/francesco/ndvi_historic_v3_compressed.zarr"
            compressor = zarr3.Blosc() # see https://github.com/pydata/xarray/issues/9987#issuecomment-2631471771
        case 2:
            HISTORIC_ZARR_v3_compr = "/data_3/scratch/francesco/ndvi_historic_v3_compressed_zstd31.zarr"
            compressor = zarr3.Blosc(cname="zstd", clevel=3, shuffle=1)
        case 3:
            HISTORIC_ZARR_v3_compr = "/data_3/scratch/francesco/ndvi_historic_v3_compressed_zstd91.zarr"
            compressor = zarr3.Blosc(cname="zstd", clevel=9, shuffle=1)
        case 4:
            HISTORIC_ZARR_v3_compr = "/data_3/scratch/francesco/ndvi_historic_v3_compressed_zstd92.zarr"
            compressor = zarr3.Blosc(cname="zstd", clevel=9, shuffle=2)
        case 5:
            HISTORIC_ZARR_v3_compr = "/data_3/scratch/francesco/ndvi_historic_v3_compressed_zstd32.zarr"
            HISTORIC_ZARR_v3_compr = "/data_3/scratch/francesco/ndvi_historic_v3_compr.zarr"
...
# =====================================================
#xr.open_zarr("/data_3/scratch/francesco/ndvi_historic_v3_compressed_zstd32.zarr")
#xr.open_zarr("/data_3/scratch/francesco/ndvi_historic_v3_compr.zarr")
...
# rsync --dry-run -a --human-readable --progress -i -e 'ssh -p 2222' /data_3/scratch/francesco/ndvi_historic_v3.zarr fabian-bernhard@dac3.ddns.net:/mnt/data1/UniBe-swiss-ndvi/data/
# rsync --dry-run -a --human-readable --progress -i -e 'ssh -p 2222' /data_3/scratch/francesco/ndvi_historic_v3_compr.zarr fabian-bernhard@dac3.ddns.net:/mnt/data1/UniBe-swiss-ndvi/data/

# and then mv ndvi_processed_all_pixels_v3_compr.zarr ndvi_historic_v3_compr.zarr
# and then mv ndvi_processed_all_pixels_v3_compr.zarr.bkp ndvi_historic_v3_compr.zarr.bkp # TODO