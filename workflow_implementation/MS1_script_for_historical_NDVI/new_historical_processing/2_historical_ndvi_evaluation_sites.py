# TODO: NOTE: this is a AI-generated version of the historical ndvi processing subset to only the evaluation sites
# NOTE: this has never been run and is untested. 
# Its intent was to have a quick way to test modfications to the historical NDVI function
# and evaluate it based on the evaluation site, allowing to reproduce report figures in a quick fashion.
